  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    (function swiperWrapper() {
      ...
      const slidersConfig = [
        ...
        {
          sliderSelector: '.types__slider',
          prevSelector: '.types-button-prev',
          nextSelector: '.types-button-next',
          swiperOptions: {
            slidesPerView: 2,
            slidesPerGroup: 1,
            spaceBetween: 10,
            ...
            pagination: {
              el: '.types__slider .swiper-pagination',
              clickable: true,
            },
            breakpoints: {
              835: {
        ...
        },
        {
          ...
          prevSelector: '.gallery-button-prev',
          nextSelector: '.gallery-button-next',
          swiperOptions: {
            slidesPerView: 2,
            slidesPerGroup: 1,
            spaceBetween: 10,
